...
// Registrar que el usuario envio el formulario
window.onload = () => {
...
function buscarImagenes() {
    ...
    const key = '25369246-2c74f7caeca868b32ab554037';
...
// Generador que registra la cantidad de elementos segun la página.
...
function mostrarImagenes(imagenes) {
    ...
    // Iterar sobre imagenes y construir html
...
function imprimirIterador() {
    ...
    while (true) {
        ...
        // Si no encuentras nada no generes nada
        if (done) return;

        // Si encuentras algo genera un numero por cada uno.
        const boton = document.createElement('A')
        boton.href = '#'
        boton.dataset.pagina = value
        boton.textContent = value;
        boton.classList.add('siguiente', 'bg-yellow-400', 'px-4', 'py-1', 'mr-2', 'font-bolder', 'mb-4', 'rounded');
